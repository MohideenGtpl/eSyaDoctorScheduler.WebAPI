    ...
    public class OpClinicDetailsRepository : IOpClinicDetailsRepository
    {
        ...
        public async Task<List<DO_EpisodeType>> GetEpisodeType()
        {
            var ep = await _context.GtEfbe01
                .Where(w => w.AllowConsultation && w.ActiveStatus)
        ...
        int specialtyId, DateTime scheduleDate)
        {
            ...
            var l_ds_1 = await _context.GtEsdocd
                ...
                .Select(x => new DO_DoctorClinicSchedule
                {
                    ...
                    TimeSlotInMintues = x.ds.d.TimeSlotInMintues,
                    ...
                    var l_ds = await _context.GtEsdocd
                        .Join(_context.GtEsdosc.Where(w => w.BusinessKey == businessKey
                         ...
                         .Select(x => new DO_DoctorClinicSchedule
                         {
                             ...
                             TimeSlotInMintues = x.d.TimeSlotInMintues,
                             IsAvailable = true,
                             IsOnLeave = false
                         }).ToListAsync();
         ...
         int specialtyId)
        {
            var l_ds = await _context.GtEsdocd
                ...
                .Select(x => new DO_DoctorClinicSchedule
                {
                    ...
                    TimeSlotInMintues = x.dc.d.TimeSlotInMintues
          ...
          int specialtyId, int doctorId)
        {
            var l_ds = await _context.GtEsdocd
                ...
                .Select(x => new DO_DoctorClinicSchedule
                {
                    ...
                    TimeSlotInMintues = x.dcs.dc.d.TimeSlotInMintues
                }).ToListAsync();
            return l_ds;
        }
